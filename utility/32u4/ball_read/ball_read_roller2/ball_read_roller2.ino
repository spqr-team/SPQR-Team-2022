// caricato su roller il 27/04
// ball read 32u4 scheda roller i sensori son shiftati tra la scheda di rick e di roller 
// i numeri dei sensori non sono quelli reali sulla scheda. Partono da S0 (davanti alla bocca)
// e si gira in senso orario 
/**
...
// PINS SCHEDA DI ROLLER 
// reading sensorNumbers faster by PORT register
#define S4  ((PIND & 2) >> 1) // PD1

#define S10 ((PINF & 64) >> 6)   // PF6
#define S11 ((PINF & 128) >> 7)  // PF7

#define S12 ((PINC & 128 ) >> 7) // PC7
#define S13 ((PINC & 64 ) >> 6)  // PC6
#define S14 ((PINB & 64) >> 6)   // PB6

#define S0  ((PINB & 16)  >> 4) // PB4
#define S1  ((PIND & 128) >> 7) // PD7
#define S2  ((PIND & 64)  >> 6) // PD6
#define S3  ((PIND & 16) >> 4)  // PD4
#define S15 ((PINB & 32) >> 5)  // PB5

#define S5  ((PIND & 1) >> 0)   // PD0
#define S6  ((PINE & 64) >> 6)  // PE6
#define S7  ((PINF & 2) >> 1)   // PF1
#define S8  ((PINF & 16) >> 4)  // PF4
#define S9  ((PINF & 32) >> 5)  // PF5
